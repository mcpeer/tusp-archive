...
# -*- coding: utf-8 -*-
"""
structure inspired by https://morvanzhou.github.io/tutorials/
Written by Evertjan Peer
"""
import numpy as np
import time
import sys
...
class KBH_Env(object):
    def __init__(self):
        ...
        self.track_lengths = [10, 7, 7, 9, 14, 14, 15, 19, 21]  # last one is washing track
    ...
    def step(self, action, event_list):
        ...
        done_ = True if len(event_list) == 0 else False  # then there is no next event
