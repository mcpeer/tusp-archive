...
Changes to V1: 
    - Again do not extract reward from score to be able to see nr of retries in score.
    - fixed correct action in replay-memory
...
if __name__ == "__main__":
    ...
    for episode in range(EPISODES):
        ...
        event_list = instance_prov.get_random_small_instance()
